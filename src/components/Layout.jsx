        ...
        <HelmetProvider>
            <Helmet>
                ...
                <meta
                    name="description"
                    content={
                        description || "Get the latest news and updates on Dehaat News."
                    }
                />
                ...
                <meta
                    property="og:image"
                    content={image || "https://dehaatnews.com/dehaatnews.jpg"}
                />
                ...
                <meta
                    ...
                    content={description || "Get the latest updates from Dehaat News."}
                />
                <meta
                    name="twitter:image"
                    content={image || "https://dehaatnews.com/dehaatnews.jpg"}
